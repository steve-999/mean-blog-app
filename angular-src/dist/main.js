...
/* harmony import */ var _display_blog_display_blog_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../display-blog/display-blog.component */ "ppPG");
...
class BlogItemComponent {
    constructor(blogService, activatedRoute, authService, userService, router) {
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](BlogItemComponent, [{
    ...
    }], function () { return [{ type: _services_blog_service__WEBPACK_IMPORTED_MODULE_2__["BlogService"] }, { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"] }, { type: src_app_services_auth_service__WEBPACK_IMPORTED_MODULE_4__["AuthService"] }, { type: src_app_services_user_service__WEBPACK_IMPORTED_MODULE_5__["UserService"] }, { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"] }]; }, null); })();
        ...
        this.userService.getUsernames()
            ...
            this.blogService.getBlogs()
                ...
                resp.forEach(blog => {
                    ...
                    const obj = Object.assign(Object.assign({}, blog), { username });
                    this.blogs.push(obj);
                });
...
AppModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineInjector"]({ factory: function AppModule_Factory(t) { return new (t || AppModule)(); }, providers: [_services_auth_service__WEBPACK_IMPORTED_MODULE_6__["AuthService"], _guards_auth_guard__WEBPACK_IMPORTED_MODULE_17__["AuthGuard"], _guards_admin_guard__WEBPACK_IMPORTED_MODULE_20__["AdminGuard"], { provide: _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HTTP_INTERCEPTORS"], useClass: _services_token_interceptor_service__WEBPACK_IMPORTED_MODULE_18__["TokenInterceptorService"], multi: true }], imports: [[
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵsetClassMetadata"](AppModule, [{
        ...
        args: [{
                ...
                providers: [_services_auth_service__WEBPACK_IMPORTED_MODULE_6__["AuthService"], _guards_auth_guard__WEBPACK_IMPORTED_MODULE_17__["AuthGuard"], _guards_admin_guard__WEBPACK_IMPORTED_MODULE_20__["AdminGuard"], { provide: _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HTTP_INTERCEPTORS"], useClass: _services_token_interceptor_service__WEBPACK_IMPORTED_MODULE_18__["TokenInterceptorService"], multi: true }],
...
class EditBlogFormComponent {
    ...
    onSubmitAddBlog(blog) {
        blog = Object.assign(Object.assign({}, blog), { userId: this.userId });
        this.showLoader = true;
...
EditBlogFormComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({ type: EditBlogFormComponent, selectors: [["app-edit-blog-form"]], decls: 17, vars: 6, consts: [[3, "showLoader"], [1, "edit-blog-form-container"], [1, "form-container", "fadeInAnimation"], [1, "error-message"], ["for", "title"], ["type", "text", "name", "title", "placeholder", "Enter the title...", 3, "ngModel", "ngModelChange"], ["for", "body"], ["name", "body", "placeholder", "Write a blog...", 3, "ngModel", "ngModelChange"], ["type", "submit", 3, "click"]], template: function EditBlogFormComponent_Template(rf, ctx) { if (rf & 1) {
    ...
    } }, directives: [_loader_loader_component__WEBPACK_IMPORTED_MODULE_6__["LoaderComponent"], _angular_forms__WEBPACK_IMPORTED_MODULE_7__["ɵangular_packages_forms_forms_y"], _angular_forms__WEBPACK_IMPORTED_MODULE_7__["NgControlStatusGroup"], _angular_forms__WEBPACK_IMPORTED_MODULE_7__["NgForm"], _angular_forms__WEBPACK_IMPORTED_MODULE_7__["DefaultValueAccessor"], _angular_forms__WEBPACK_IMPORTED_MODULE_7__["NgControlStatus"], _angular_forms__WEBPACK_IMPORTED_MODULE_7__["NgModel"]], styles: [".edit-blog-form-container[_ngcontent-%COMP%] {\r\n    width: 100%;\r\n    display: flex;\r\n    flex-direction: column;\r\n    justify-content: flex-start;\r\n    align-items: center;\r\n}\r\n\r\nh2[_ngcontent-%COMP%] {\r\n    font-family: 'Roboto', sans-serif;\r\n    color: darkslateblue;\r\n    margin: 0 auto;\r\n    text-align: center;\r\n    font-size: 18px;\r\n    font-weight: 700;\r\n    letter-spacing: 0px;\r\n}\r\n\r\n.form-container[_ngcontent-%COMP%] {\r\n    max-width: 900px;\r\n    width: 80%;\r\n    background-color: #eee;\r\n    margin: 20px auto 50px auto;\r\n    padding: 25px;\r\n    border: 1px solid #ddd;\r\n    border-radius: 10px;\r\n    box-shadow: 0 4px 4px -1px rgba(0,0,0,0.2);\r\n}\r\n\r\nform[_ngcontent-%COMP%], label[_ngcontent-%COMP%] {\r\n    background-color: #eee;\r\n}\r\n\r\ninput[_ngcontent-%COMP%], label[_ngcontent-%COMP%], button[_ngcontent-%COMP%], textarea[_ngcontent-%COMP%] {\r\n    display: block;\r\n    width: 100%;\r\n}\r\n\r\ninput[_ngcontent-%COMP%], textarea[_ngcontent-%COMP%] {\r\n    padding: 6px;\r\n    margin-bottom: 20px;\r\n    border-radius: 5px;\r\n    border: 1px solid #ddd;\r\n    box-shadow: 0 0 5px -1px #ddd;\r\n}\r\n\r\ntextarea[_ngcontent-%COMP%] {\r\n    height: 300px;\r\n}\r\n\r\ninput[_ngcontent-%COMP%]:focus, textarea[_ngcontent-%COMP%]:focus {\r\n    outline: none !important;\r\n    border: 2px solid cornflowerblue;\r\n}\r\n\r\nlabel[_ngcontent-%COMP%] {\r\n    padding: 6px;\r\n    font-size: 17px;\r\n    font-family: Calibri, sans-serif;\r\n}\r\n\r\n.error-message[_ngcontent-%COMP%] {\r\n    color: crimson;\r\n    font-size: 18px;\r\n    margin: 0 auto;\r\n    text-align: center;\r\n}\r\n\r\n@media screen and (max-width: 800px) {\r\n    .form-container[_ngcontent-%COMP%] { width: 85%; }\r\n}\r\n\r\n@media screen and (max-width: 650px) {\r\n    .form-container[_ngcontent-%COMP%] { width: 90%; }\r\n}\n/*# sourceMappingURL=data:application/json;base64, */"] });
...
AuthService.ɵfac = function AuthService_Factory(t) { return new (t || AuthService)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClient"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_angular_router__WEBPACK_IMPORTED_MODULE_5__["Router"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_user_service__WEBPACK_IMPORTED_MODULE_6__["UserService"])); };
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](AuthService, [{
    ...
    }], function () { return [{ type: _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClient"] }, { type: _angular_router__WEBPACK_IMPORTED_MODULE_5__["Router"] }, { type: _user_service__WEBPACK_IMPORTED_MODULE_6__["UserService"] }]; }, null); })();
...
DisplayBlogComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: DisplayBlogComponent, selectors: [["app-display-blog"]], inputs: { blog: "blog", parent: "parent" }, features: [_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵNgOnChangesFeature"]], decls: 11, vars: 9, consts: [[1, "blog-card", "fadeInAnimation"], [1, "blog-title"], [3, "ngClass", "routerLink"], [1, "blog-body", 3, "innerHTML"], [1, "author-date"], [1, "user-id-text"]], template: function DisplayBlogComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](3);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate"]((ctx.blog == null ? null : ctx.blog.username) ? ctx.blog == null ? null : ctx.blog.username : ctx.blog == null ? null : ctx.blog.userId);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](2);
    ...
    } }, directives: [_angular_router__WEBPACK_IMPORTED_MODULE_3__["RouterLinkWithHref"], _angular_common__WEBPACK_IMPORTED_MODULE_4__["NgClass"]], pipes: [_angular_common__WEBPACK_IMPORTED_MODULE_4__["DatePipe"]], styles: ["\r\n.blog-card * {\r\n    background-color: #f4f4f4;\r\n    font-family: 'Montserrat', sans-serif;\r\n}\r\n\r\n.blog-card {\r\n    background-color: #f4f4f4;\r\n    width: 100%;\r\n    max-width: 900px;\r\n    border: 0.5px solid #ddd;\r\n    border-radius: 10px;\r\n    margin: 25px auto;\r\n    padding: 30px 25px;\r\n    box-shadow: 0 4px 4px -1px rgba(0,0,0,0.2);\r\n}\r\n\r\n.blog-card h3 {\r\n    padding: 5px 5px 15px 0px;\r\n    margin: 0px 0;\r\n}\r\n\r\n.blog-card .linkEnabled,\r\n.blog-card .linkDisabled {\r\n    color: darkslateblue;   \r\n    text-decoration: none;\r\n    font-family: 'Roboto', sans-serif;\r\n    font-size: 19px;\r\n    font-weight: 700;\r\n    text-transform: capitalize;\r\n    letter-spacing: 0px;\r\n}\r\n\r\n.blog-card .linkDisabled {\r\n    cursor: default;\r\n}\r\n\r\n.blog-card .linkEnabled:hover {\r\n    color: crimson;\r\n    text-decoration: underline;\r\n}\r\n\r\n.blog-card .blog-body p {\r\n    background-color: #f4f4f4;\r\n    font-size: 15px;\r\n    font-weight: 500;\r\n    line-height: 1.6;\r\n    padding: 8px 0;\r\n}\r\n\r\n.blog-card .user-id-text {\r\n    font-family: 'Open Sans', sans-serif;\r\n    font-size: 14px;\r\n    display: inline-block;\r\n    margin-top: 12px;\r\n    padding-right: 15px;\r\n}\r\n\r\n.blog-card .author-date {\r\n    padding: 5px 8px;\r\n}\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n/*# sourceMappingURL=data:application/json;base64, */"], encapsulation: 2 });
...
LoaderComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: LoaderComponent, selectors: [["app-loader"]], inputs: { showLoader: "showLoader" }, decls: 2, vars: 7, consts: [[3, "ngClass"]], template: function LoaderComponent_Template(rf, ctx) { if (rf & 1) {
    ...
    } }, directives: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["NgClass"]], styles: [".loader-container[_ngcontent-%COMP%] {\r\n    position: absolute;\r\n    top: 0;\r\n    left: 0;\r\n    width: 100%;\r\n    height: 500px;\r\n    display: flex;\r\n    flex-direction: column;\r\n    justify-content: center;\r\n    align-items: center;\r\n    animation: fadeIn 2s ease-in;\r\n}\r\n\r\n.hidden[_ngcontent-%COMP%] {\r\n    display: none;\r\n    height: 0;\r\n}\r\n\r\n.loader[_ngcontent-%COMP%] {\r\n    border: 10px solid #f3f3f3; \r\n    border-top: 10px solid rgb(58, 225, 255);\r\n    border-radius: 50%;\r\n    width: 80px;\r\n    height: 80px;\r\n    animation-name: spin;\r\n    animation-duration: 1s;\r\n    animation-timing-function: linear; \r\n    animation-iteration-count: infinite;\r\n    animation-delay: 0;\r\n}\r\n\r\n@keyframes spin {\r\n    0% { transform: rotate(0deg); }\r\n    100% { transform: rotate(360deg); }\r\n}\n/*# sourceMappingURL=data:application/json;base64, */"] });
